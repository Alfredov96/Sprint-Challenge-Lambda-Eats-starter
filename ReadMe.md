...
it routes to a file you are trying to link to

2. How would you explain form validation to someone who has never programmed before?

its in the name its us verifying what we would like test

3. In 1-2 sentences, define end to end testing. 

this is also in the name its us testing our code from top to bottom
